  ...
  hooks: {
    beforeValidate: [
      ({ data, originalDoc }) => {
        ...
        if (merged.approved) validatePricingSettings(merged);
        return data;
      },
    ],
    afterChange: [
  ...
  fields: [
    {
      ...
      type: "checkbox",
      defaultValue: false,
      label: "Approved for public estimates",
      admin: {
        description:
    ...
    },
    {
      ...
      defaultValue: [
        {
          label: "Fara iluminat integrat",
          value: "none",
          fixedRon: 0,
          perSqmRon: 0,
        },
        {
          label: "Banda LED perimetrala",
          value: "perimeter-led",
          fixedRon: 400,
          perSqmRon: 45,
        },
        {
          label: "Iluminat complex",
