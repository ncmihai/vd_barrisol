...
const internalFieldRead: FieldAccess = ({ req: { user } }) =>
  ...
  fields: [
    {
      ...
      defaultValue: 50,
      admin: {
        description: "Horizontal focal point for cropped images, in percent.",
      },
    },
    {
      name: "focalY",
      ...
      defaultValue: 50,
      admin: {
        description: "Vertical focal point for cropped images, in percent.",
      },
    },
    {
      name: "title",
